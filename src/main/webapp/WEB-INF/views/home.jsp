										...
										Kakao.API
												.request({
													...
													success : function(result) {
														...
														location.href = "/saeha/sae_member/kakao?userId="
																+ profile_nickname
																+ "&&email="
																+ email
																+ "&&birthday="
...
var naverLogin = new naver.LoginWithNaverId(
		{
			...
			callbackUrl: "http://localhost:8080/saeha/", // 내 애플리케이션 API설정의 Callback URL 을 입력해줍니다.
			isPopup: false,
			callbackHandle: true,
...
$("#naverIdLogin").on("click", function () {
	...
	naverLogin.getLoginStatus(function (status) {
		...
		if (status) {
            ...
            location.href = "/saeha/sae_member/naver?userId="
