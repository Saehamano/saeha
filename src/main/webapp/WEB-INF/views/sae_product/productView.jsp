	...
	<section id="container">
		<form name="readForm" role="form" method="post">
			<input type="hidden" id="pd_bno" name="pd_bno"
				...
				<input type="hidden" id="pd_type" name="pd_type" value="${read.pd_type }"/>
		</form>
		...
		<div class="form-grop">
			<img src="/resources/productimg/${read.pd_file }" />
		</div>
		...
		<div>
			...
			<button type="button" class="cart_btn btn btn-primary">장바구니에 담기</button>
		</div>
	</section>
</body>
</html>